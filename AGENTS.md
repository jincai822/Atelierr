...
`uv run scripts/atelier/render_runtime_edges.py --runtime codex --apply` instead of
hand-editing them. Run `python3 scripts/atelier/harness_lint.py` and
`.venv/bin/python scripts/atelier/harness_smoke.py` before finishing.

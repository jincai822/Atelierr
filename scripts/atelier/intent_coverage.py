...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="scripts/atelier/intent_coverage.py",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        description="Inspect and log Atelier hi intent coverage for Claude `/hi` and Codex `$hi`.",
        epilog=textwrap.dedent(
            """\
            Examples:
              python3 scripts/atelier/intent_coverage.py intent "review my goals"
              python3 scripts/atelier/intent_coverage.py intent "https://arxiv.org/abs/2501.12345"
              python3 scripts/atelier/intent_coverage.py intent "5/4 早上去了 X" --json
              python3 scripts/atelier/intent_coverage.py intent-log --input "improve the repo" \\
              ...
              python3 scripts/atelier/intent_coverage.py intent-misses --since 2026-05-01
            """
        ),
    )

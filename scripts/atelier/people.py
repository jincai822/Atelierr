...
Usage:
    scripts/atelier/people.py "fragment"            # match by filename stem
    scripts/atelier/people.py "fragment" --json     # JSON output

    # Enable body match for non-English queries:
    ATELIER_PEOPLE_NAME_FIELD='<label>' scripts/atelier/people.py "fragment"
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(
        prog="scripts/atelier/people.py",

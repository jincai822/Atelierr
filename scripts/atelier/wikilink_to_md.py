...
Usage:
  uv run scripts/atelier/wikilink_to_md.py --dry-run --file zk/wiki/Foo.md
  uv run scripts/atelier/wikilink_to_md.py --dry-run --tier wiki --limit 3
  uv run scripts/atelier/wikilink_to_md.py --dry-run --all --quiet
  uv run scripts/atelier/wikilink_to_md.py --apply --all
"""

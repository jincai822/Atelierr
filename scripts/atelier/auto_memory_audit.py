...
CLI:
    uv run scripts/atelier/auto_memory_audit.py            human report
    uv run scripts/atelier/auto_memory_audit.py --json     machine-readable
    uv run scripts/atelier/auto_memory_audit.py --threshold 60   custom stale window
    uv run scripts/atelier/auto_memory_audit.py --dir <path>     custom memory dir
...
Design notes:
  - Stdlib only. Mirrors scripts/atelier/zk_audit.py / privacy_check.py style.

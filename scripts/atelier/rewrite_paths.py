...
Workflow:
    ...
    2. Run `uv run scripts/atelier/rewrite_paths.py --from <old> --to <new>`.
...
def main(argv: list[str] | None = None) -> int:
    ...
    print(summary)
    if not args.dry_run:
        print("Next: review the diff and run `uv run scripts/atelier/harness_lint.py` to confirm clean.")
    return 0

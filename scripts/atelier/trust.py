...
CLI:
    scripts/atelier/trust.py                         default table over zk/wiki/
    scripts/atelier/trust.py --note zk/wiki/foo.md   per-claim breakdown
    scripts/atelier/trust.py --as-of 2025-06-01      bi-temporal snapshot
    scripts/atelier/trust.py --json                  structured output for /lint
    scripts/atelier/trust.py --index                 write zk/wiki/index.md
...
def format_index(
    ...
    lines.append("")
    lines.append(f"Auto-generated by `scripts/atelier/trust.py --index` on {as_of.isoformat()}.")

...
CLI:
    scripts/atelier/staleness.py                 human report
    scripts/atelier/staleness.py --json          structured output
    scripts/atelier/staleness.py --dir zk/wip   scan a single L2 directory
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(
        prog="scripts/atelier/staleness.py",

...
Usage:
    ...
    scripts/atelier/snapshot_anchors.py

    # Save to Readwise and backfill IDs into wiki files
    scripts/atelier/snapshot_anchors.py --apply

    # Process a single wiki entry
    scripts/atelier/snapshot_anchors.py --apply --note zk/wiki/some-entry.md

    # Skip URL categories that don't scrape well
    scripts/atelier/snapshot_anchors.py --apply --skip-categories github_code,deepwiki

    # Just report: show URLs grouped by category
    scripts/atelier/snapshot_anchors.py --report
...
See also:
    ...
    scripts/atelier/lint.py            WARN on missing readwise: (readwise-missing)
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(
        prog="scripts/atelier/snapshot_anchors.py",

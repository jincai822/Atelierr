...
CLI:
    uv run scripts/atelier/privacy_check.py                   human report
    uv run scripts/atelier/privacy_check.py --json            machine-readable output
    uv run scripts/atelier/privacy_check.py --allow-empty-ov  exit 0 when $OV is unset
...
def main(argv: list[str] | None = None) -> int:
    ap = argparse.ArgumentParser(
        prog="scripts/atelier/privacy_check.py",
        description=(

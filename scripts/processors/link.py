...
- category：从下方分类表选 1 个最贴切的类目，优先选二级类（如 B84-心理学）；二级无合适的用大类（如 B-哲学）；无法归类用 Z-综合。**类目必须带类名**（照抄表内条目如 G79自学·自我提升），禁止只给裸编号（如 G79）——裸编号无法归档，等于没分类。禁止编造表外编号，拿不准就选更宽的类。哲学内容优先细分到 B2/B5/B84 等二级类，跨多个哲学分支才用 B-哲学；教育体制/升学/专业选择归 G4，个人自我提升方法归 G79；探讨「为什么/意义/价值」类话题（为什么上学、工作的意义、人生选择等）归 B82伦理·价值观 或相应 B 二级类，不归 G4/G79——G 类只收教育方法本身。
- topics：3-6 个自由主题词，短语，覆盖跨领域内容。
只依据原文，不得补充原文没有的内容。不要输出 JSON 以外的任何内容。

分类表：
B 哲学·宗教：B2中国哲学 B5外国哲学 B80思维科学 B81逻辑学 B82伦理·价值观 B83美学 B84心理学
